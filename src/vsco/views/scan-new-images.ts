...
export function makeScanNewImagesMenu(model: NewImagesModel) : ElementBuilder<HTMLDivElement> {
	...
	model.listen("staleUserCount", ({newValue:count})=>staleUserSpan.innerText = 'due:'+count, true);
	model.listen("newImageUserCount", ({newValue:count})=>newImagesSpan.innerText='images:'+count, true);
